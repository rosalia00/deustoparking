...
/*estadistica 1: selecciona el precio medio de los bonos para comporaciones con otras empresas
 * SELECT AVG(PRECIO) FROM BONO
 *
 * o selecciona precio medio de reservas
